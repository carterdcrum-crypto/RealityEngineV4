...
class CallActivity : Activity() {
    ...
    private fun buildUi(){
        ...
        root.addView(Button(this).apply{text="KEYPAD";setOnClickListener{keypadContainer.visibility=if(keypadContainer.visibility==View.VISIBLE)View.GONE else View.VISIBLE}})
    ...
    private fun refresh(){
        call=CallSessionRegistry.primary();val current=call;if(current==null){finish();return};val number=current.details?.handle?.schemeSpecificPart?:"UNKNOWN CALLER";caller.text=resolveCallerLabel(number)
