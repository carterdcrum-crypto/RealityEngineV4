...
class CallActivity : Activity() {
    ...
    private fun buildUi(){
        ...
        val controls=LinearLayout(this).apply{orientation=LinearLayout.HORIZONTAL;gravity=Gravity.CENTER};muteButton=Button(this).apply{setOnClickListener{toggleMute()}};speakerButton=Button(this).apply{setOnClickListener{toggleSpeaker()}};holdButton=Button(this).apply{setOnClickListener{toggleHold()}}
        controls.addView(muteButton,LinearLayout.LayoutParams(0,58.dp(),1f).apply{setMargins(4,4,4,4)});controls.addView(speakerButton,LinearLayout.LayoutParams(0,58.dp(),1f).apply{setMargins(4,4,4,4)});controls.addView(holdButton,LinearLayout.LayoutParams(0,58.dp(),1f).apply{setMargins(4,4,4,4)});root.addView(controls)
