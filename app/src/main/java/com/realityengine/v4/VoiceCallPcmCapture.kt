...
/** 16 kHz PCM capture backed by the privileged Shizuku UserService. */
class VoiceCallPcmCapture(context:Context){
 ...
 companion object{const val SAMPLE_RATE=16_000;private const val READ_CHUNK_BYTES=8_192;private const val READ_IDLE_MS=10L;private const val CONNECT_ATTEMPTS=3;private const val CONNECT_RETRY_MS=350L}
}
