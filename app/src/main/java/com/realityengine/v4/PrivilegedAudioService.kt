...
class PrivilegedAudioService : Binder() {
    ...
    @Synchronized private fun startCapture():Int{
        ...
        for(source in intArrayOf(MediaRecorder.AudioSource.VOICE_CALL,MediaRecorder.AudioSource.VOICE_DOWNLINK,MediaRecorder.AudioSource.VOICE_UPLINK)){
            ...
            if(ok){recorder=candidate;activeSource=source;started=true;return START_OK}
