...
class AboutScreen(private val activity: Activity, private val onBack: () -> Unit) {
    ...
    private val bodyTextColor = Color.rgb(205, 241, 248)
    ...
    private fun build(): View {
        ...
        body.addView(TextView(activity).apply {
            text = "Reality Engine provides conversation assistance and context. Its signals are not proof of deception and should be interpreted by the user."
            setTextColor(muted)
